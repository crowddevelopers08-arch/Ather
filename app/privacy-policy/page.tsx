  ...
  return (
    ...
    <div className="bg-white text-gray-800 px-4 py-12 mt-20 max-[470px]:mt-10">
      <div className="max-w-4xl mx-auto">
        {/* Header */}
        <div className="mb-10 border-b border-[#ee5335]/20 pb-6">
          <h1 className="text-3xl md:text-4xl font-bold text-[#111] mb-3">
            Privacy Policy
          </h1>
          <div className="flex items-center text-[#ee5335]">
        ...
        {/* Introduction */}
        <section className="mb-10 bg-[#f4f8ee] p-6 rounded-lg border border-[#ee5335]/20">
          <p className="text-[#333] leading-relaxed">
            At <span className="font-bold text-[#ee5335]">Ather Medavakkam</span>, we are committed to protecting your privacy and personal information. 
        ...
        <section className="mb-10">
          <div className="flex items-center mb-4">
            <div className="w-10 h-10 rounded-full bg-[#ee5335] text-black flex items-center justify-center font-bold mr-4">
              1
            </div>
          ...
          <ul className="space-y-3">
            <li className="flex items-start">
              <div className="w-2 h-2 bg-[#ee5335] rounded-full mt-2 mr-3 flex-shrink-0"></div>
              <span className="text-[#333]">
                <strong className="text-[#ee5335]">Personal Information:</strong> Name, email address, phone number, and other contact details you provide when booking test rides or contacting us.
              </span>
            </li>
            <li className="flex items-start">
              <div className="w-2 h-2 bg-[#ee5335] rounded-full mt-2 mr-3 flex-shrink-0"></div>
              <span className="text-[#333]">
                <strong className="text-[#ee5335]">Vehicle Preferences:</strong> Model interest (Ather 450 / Rizta), preferred test ride timing, and other preferences you share.
              </span>
            </li>
            <li className="flex items-start">
              <div className="w-2 h-2 bg-[#ee5335] rounded-full mt-2 mr-3 flex-shrink-0"></div>
              <span className="text-[#333]">
                <strong className="text-[#ee5335]">Usage Data:</strong> Information about how you use our website, including IP address, browser type, pages visited, and time spent on our site.
              </span>
            </li>
            <li className="flex items-start">
              <div className="w-2 h-2 bg-[#ee5335] rounded-full mt-2 mr-3 flex-shrink-0"></div>
              <span className="text-[#333]">
                <strong className="text-[#ee5335]">Communication Data:</strong> Records of your communications with us, including emails, messages, and phone calls.
              </span>
            </li>
          </ul>
        </section>
          ...
          <ul className="space-y-2">
            {[
              ...
              <li key={index} className="flex items-start">
                <div className="w-6 h-6 rounded-full bg-[#f4f8ee] border border-[#ee5335]/20 text-[#ee5335] flex items-center justify-center text-sm font-bold mr-3 mt-0.5 flex-shrink-0">
                  {index + 1}
                </div>
        ...
        <section className="mb-10">
          ...
          <div className="bg-[#f4f8ee] p-5 rounded-lg border border-[#ee5335]/20">
            <p className="text-[#333] leading-relaxed">
        ...
        <section className="mb-10">
          ...
          <ul className="space-y-2">
            {[
              ...
              <li key={index} className="flex items-start">
                <div className="w-5 h-5 rounded-full bg-[#ee5335]/20 mr-3 mt-1 flex-shrink-0"></div>
                <span className="text-[#333]">{item}</span>
              </li>
            ))}
          </ul>
        ...
        <section className="mb-12">
          ...
          <div className="bg-[#f4f8ee] p-6 rounded-lg border border-[#ee5335]/20">
        ...
        {/* Footer */}
        <footer className="border-t border-[#ee5335]/20 pt-6">
